...
const db1 = getDatabase(appEscrita);
 ...
 // Elementos do DOM
    ...
    function carregarAtletas() {
      const atletaRef = ref(db, "avaliacaodejuradoD/classificatória/1º Jogo/juradoD");
    ...
    function carregarVideo(atletaKey) {
      const atletaRef = ref(db, `avaliacaodejuradoD/classificatória/1º Jogo/juradoD/${atletaKey}`);
      onValue(atletaRef, (snapshot) => {
