...
const db1 = getDatabase(appEscrita);
 ...
 // Elementos do DOM
    ...
    function carregarAtletas() {
      const atletaRef = ref(db, "avaliacaodejuradoF/classificatória/1º Jogo/juradoF");
    ...
    function carregarVideo(atletaKey) {
      const atletaRef = ref(db, `avaliacaodejuradoF/classificatória/1º Jogo/juradoF/${atletaKey}`);
      onValue(atletaRef, (snapshot) => {
